...
namespace Alura.Estacionamento.Modelos
{
    public class Veiculo
    {
        ...
        public string Proprietario
        {
            ...
            set
            {
                if (value.Length < 3) throw new System.FormatException("Nome do proprietário deve conter mais de dois caracteres.");
                _proprietario = value;  
        ...
        public void AlteraDados(Veiculo veiculoNovosDados)
        {
            this.Proprietario = veiculoNovosDados.Proprietario;
            this.Cor = veiculoNovosDados.Cor;
            this.Modelo = veiculoNovosDados.Modelo;
        }
